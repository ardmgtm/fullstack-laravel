    ...
    <div class="bg-[url('/images/background-pkt.jpg')] w-full h-screen bg-cover bg-no-repeat flex">
        ...
        <div class="grow my-auto mx-24">
            ...
            <p class="text-white pt-6">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam varius, arcu in sagittis congue, ante turpis porta purus, nec dignissim mauris elit vel odio. Fusce molestie felis sed facilisis egestas. Nullam pretium luctus urna nec egestas. Vestibulum tempus nunc tortor, ac feugiat lorem facilisis ut. Donec mattis ex ut venenatis sagittis. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Integer vitae quam lorem.
            </p>
        </div>
        <div class="rounded-2xl bg-white p-8 shadow-xl my-auto grow-0 mr-10">
            <div class="flex align-middle items-center flex-col">
                ...
                <div class="w-80 pt-8">
                    <el-form ref="formLoginRef" :model="form" label-width="200px" label-position="top" require-asterisk-position="right">
